...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const base =
      "inline-flex items-center justify-center font-medium rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 disabled:opacity-50 disabled:cursor-not-allowed";
