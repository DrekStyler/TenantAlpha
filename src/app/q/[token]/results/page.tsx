  ...
  return (
    <div className="min-h-screen bg-navy-50 px-4 py-6 sm:py-8">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Lease Comparison Dashboard or ROI Deep Dive */}
        ...
        {data.roiOutputs && (
          <div className="mb-6">
            <LeasePlayground
              defaults={buildPlaygroundDefaults(data)}
              roiCalcInputs={buildPlaygroundROIInputs(data)}
...
function buildPlaygroundDefaults(data: SurveyResults): PlaygroundDefaults {
  ...
  return {
    ...
    headcount: ci?.costAvoidance?.headcount ?? 25,
    annualRevenue: ci?.productivity?.annualRevenue ?? 5_000_000,
  };
}

function buildPlaygroundROIInputs(data: SurveyResults): PlaygroundROIInputs | null {
  const ci = data.roiCalcInputs;
  if (!ci) return null;
  return {
